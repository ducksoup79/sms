...
$inc_num = sanatizeString($_GET['inc_num']);

echo '<div id="printableArea">';
     

$query=  queryMysql("SELECT * FROM incident_reports WHERE inc_num='$inc_num'");
echo '<h2>Incident Report '.$inc_num.'</h2>';
echo '<table>';
...
$query2=  queryMysql("SELECT * FROM risk_assesment WHERE occurence_num='$inc_num'");
echo '<h2>Risk Assesment for '.$inc_num.'</h2>';
echo '<table>';
